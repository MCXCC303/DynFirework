...
from gui.lib.firework_trajectories import expanding_trajectory_with_random_offset
...
particle_count = 5
speed_factor = 0.1
expand_labels = ['x', 'y', 'z', 'Particle Counts', 'Expands (speed_factor)']
lifetime = 0.5
...
class ExpdTrajWithIntervalForm:
    def __init__(self, root):
        ...
        for i, label in enumerate(expand_labels):
    ...
    def submit(self):
        global end_tick, x0, y0, z0, x1, y1, z1, duration, m0, k, lifetime, points_per_tick, interval_ticks, range_x, range_y, range_z, speed_factor, particle_count
        ...
        speed_factor = float(self.group_entries['Expands (speed_factor)'].get())
        ...
        messagebox.showinfo('Expanding Trajectory with interval',
                            f'Generated Expanding Trajectory with interval\nFrom:\n({x0}, {y0}, {z0})\nTo:\n({x1}, {y1}, {z1})')
