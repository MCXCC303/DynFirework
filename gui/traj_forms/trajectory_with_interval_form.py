...
class TrajWithIntervalForm:
    def __init__(self, root):
        ...
        tk.Label(self.root, text="Trajectory with interval", font=('Arial', 50, 'bold')).grid(
            row=0,
            column=0,
            pady=30,
            padx=50,
        ...
        interval_frame.grid(row=2, column=0, padx=30, pady=30, columnspan=2, sticky=tk.NSEW)
